...
| 6.0.0    | 6.1.0    | [v6.0.0-to-v6.1.0.md](v6.0.0-to-v6.1.0.md) | non-breaking | AGENTIFY.md consolidation of loop iter-02..06 + manual closures: cross-section + forward-pointer gates, M-doc-drift enumeration discipline. Prompt-only; zero-touch upgrade. |
